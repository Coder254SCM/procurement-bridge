    ...
    <footer className="bg-secondary/50 pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-lg font-semibold mb-4">ProcureChain</h3>
            <p className="text-muted-foreground mb-4">
              Transforming procurement in Kenya through blockchain technology, transparency, and efficiency.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/documentation" className="text-muted-foreground hover:text-primary transition-colors flex items-center">
                  <BookOpen size={16} className="mr-2" />
                  Documentation
                </Link>
              </li>
              <li>
                <Link to="/guides" className="text-muted-foreground hover:text-primary transition-colors flex items-center">
            ...
            <div className="mt-6">
              ...
              <form className="flex">
                <input 
                  ...
                  className="py-2 px-3 bg-white rounded-l-md border border-border focus:outline-none focus:ring-1 focus:ring-primary w-full"
                />
                <button 
                  type="submit" 
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © {currentYear} ProcureChain. All rights reserved.
            </p>
