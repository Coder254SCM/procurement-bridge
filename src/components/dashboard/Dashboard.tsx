    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Welcome back, let's manage your procurement processes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card className="hover-lift">
          ...
          <CardFooter className="pt-0">
            <span className="text-xs text-muted-foreground flex items-center">
              ...
              {userType === 'buyer' ? '3 new this week' : '2 new matches'}
            </span>
          </CardFooter>
        </Card>
        ...
        <Card className="hover-lift">
          ...
          <CardFooter className="pt-0">
            <span className="text-xs text-muted-foreground flex items-center">
              ...
              {userType === 'buyer' ? '2 due today' : '3 pending review'}
            </span>
          </CardFooter>
        </Card>
        ...
        <Card className="hover-lift">
          ...
          <CardFooter className="pt-0">
            <span className="text-xs text-muted-foreground flex items-center">
              <TrendingUp className="h-3 w-3 mr-1 text-green-500" />
              {userType === 'buyer' ? '7 new registrations' : '5 new inquiries'}
            </span>
          </CardFooter>
        </Card>
        ...
        <Card className="hover-lift">
          ...
          <CardFooter className="pt-0">
            <span className="text-xs text-muted-foreground flex items-center">
              <TrendingUp className="h-3 w-3 mr-1 text-green-500" />
              {userType === 'buyer' ? '2% increase' : '5% increase'}
            </span>
          </CardFooter>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        <Card className="col-span-1 lg:col-span-2 hover-lift">
          <CardHeader>
            ...
            <CardDescription>Track and manage your recent tenders</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="hover-lift">
          ...
          <CardContent>
            <div className="space-y-4">
              {[1, 2, 3].map((item) => (
                <div key={item} className="p-3 bg-secondary/50 rounded-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="relative pl-6 pb-6 before:absolute before:left-0 before:top-0 before:h-full before:w-px before:bg-border">
        ...
        <Card className="hover-lift">
          <CardHeader>
            <CardTitle>
              {userType === 'buyer' ? 'Recent Activities' : 'Recent Activities'}
            </CardTitle>
